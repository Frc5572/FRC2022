...
public class MagazineRPM extends CommandBase {
    ...
    private void updateSetpoint() {
        ...
        if (shooterRPM >= 3300) {
            this.innerMagazine.setSetpoint(750);
        } else if (shooterRPM >= 3100) {
            this.innerMagazine.setSetpoint(850);
        } else if (shooterRPM >= 2900) {
            this.innerMagazine.setSetpoint(1000);
        } else if (shooterRPM >= 2300) {
            this.innerMagazine.setSetpoint(1100);
        } else {
            this.innerMagazine.setSetpoint(2000);
        }
    }
