 ...
 */
public class Heart extends AutoBase {
     ...
     */
    public Heart(Swerve swerve, Shooter shooter, InnerMagazine innerMagazine,
        ...
        PathPlannerTrajectory trajectory = PathPlanner.loadPath("Heart", 6, 3);
