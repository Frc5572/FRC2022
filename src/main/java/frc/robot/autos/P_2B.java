...
public class P_2B extends AutoBase {
     ...
     */
    public P_2B(Swerve swerve, Shooter shooter, ShooterRoller shooterRoller,
        InnerMagazine innerMagazine, OuterMagazine outerMagazine, Intake intake, Turret turret,
        Vision vision) {
        super(swerve);
        ...
        this.intake = intake;
        addRequirements(shooter, shooterRoller, innerMagazine, outerMagazine, intake, turret);
