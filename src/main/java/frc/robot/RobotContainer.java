...
import frc.robot.autos.TurnToAngle;
...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        final Command turnTest = new WaitCommand(0.25).andThen(new TurnToAngle(swerveDrive, 90));
        ...
        autoChooser.addOption("Test Turn2Angle", turnTest);
